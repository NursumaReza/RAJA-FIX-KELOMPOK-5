            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{('/admin/pembimbing')}}">Pembimbing</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Seminar<i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="{{('/admin/proposal')}}">Proposal</a></li>
                                <li><a href="{{('/admin/hasil')}}l">Hasil</a></li>
                                <li><a href="{{('/admin/ujian')}}">Ujian</a></li>
                            </ul>
                        </li>
                        <li><a href="{{('/admin/nilai')}}">Nilai</a></li> 
                        <li><a href="{{('/admin/registrasi')}}">Registrasi</a></li>
